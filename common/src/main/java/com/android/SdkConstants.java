...
public final class SdkConstants {
    ...
    public static final String LATEST_CONSTRAINT_LAYOUT_VERSION = "1.0.0-alpha5";
    ...
    public static final String GRADLE_PLUGIN_RECOMMENDED_VERSION = "2.2.0-beta1";
    public static final String GRADLE_EXPERIMENTAL_PLUGIN_RECOMMENDED_VERSION = "0.8.0-beta1";
