...
public final class SdkConstants {
    ...
    public static final String GRADLE_PLUGIN_RECOMMENDED_VERSION = "2.2.0-rc2";
    public static final String GRADLE_EXPERIMENTAL_PLUGIN_RECOMMENDED_VERSION = "0.8.0-rc2";
