...
public final class SdkConstants {
    ...
    public static final String CLASS_CONSTRAINT_LAYOUT = "android.constraint.ConstraintLayout";     //$NON-NLS-1$
    public static final String CLASS_TABLE_CONSTRAINT_LAYOUT = "android.constraint.TableConstraintLayout";     //$NON-NLS-1$
    public static final String CLASS_CONSTRAINT_LAYOUT_GUIDELINE = "android.constraint.Guideline";     //$NON-NLS-1$
    public static final String CONSTRAINT_LAYOUT_LIB_ARTIFACT = "com.android.constraint:constraint-layout";
    ...
    public static final String GRADLE_PLUGIN_RECOMMENDED_VERSION = "2.2.0-alpha1";
