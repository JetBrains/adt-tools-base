...
public class Hierarchy implements BinaryObject {
  AtomGroup Root;
  ...
  // Constructs and decodes a {@link Hierarchy} from the {@link Decoder} d.
  public Hierarchy(Decoder d) throws IOException {
    decode(d);
  }
  ...
  // Setters
  public void setRoot(AtomGroup v) {
    Root = v;
  }
  ...
  public ObjectTypeID type() {
    return ObjectFactory.HierarchyID;
  }
}