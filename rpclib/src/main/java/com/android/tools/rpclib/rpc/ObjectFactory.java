...
class ObjectFactory {
  ...
  public static byte[] ClassIdInfoIDBytes = {47, -80, -62, -36, -63, -9, -48, -67, 51, 126, 101, 35, 71, -52, 28, -3, 4, 17, -28, 46,};
  public static ObjectTypeID ClassIdInfoID = new ObjectTypeID(ClassIdInfoIDBytes);
  ...
  public static byte[] DeviceIDBytes = {-70, -71, -20, -44, 24, 61, -69, 34, 115, 101, -5, 9, 126, -124, -128, -68, 98, -50, -33, -15,};
  ...
  public static byte[] SchemaIDBytes = {57, -39, -85, -69, -17, -74, 96, -69, 95, -5, -88, 74, 116, 73, 77, 77, -58, -44, -125, 72,};
  ...
  public static byte[] TimingInfoIDBytes = {-87, 34, -115, 99, -9, -96, 116, -119, 71, 20, -108, -79, 7, -45, 55, 49, 22, -102, 79, -110,};
  ...
  static {
    ...
    ObjectTypeID.register(ClassIdInfoID, Entries.ClassIdInfoEnum);
  ...
  public static void encode(Encoder e, ClassIdInfo o) throws IOException {
    e.string(o.Name);
    o.Kind.encode(e);
    e.object(o.Klass);
  }

  public static void decode(Decoder d, ClassIdInfo o) throws IOException {
    o.Name = d.string();
    o.Kind = TypeKind.decode(d);
    o.Klass = (ClassInfo)d.object();
  }
  ...
  public static void encode(Encoder e, Schema o) throws IOException {
    ...
    e.int32(o.ClassIds.length);
    for (int i = 0; i < o.ClassIds.length; i++) {
      e.object(o.ClassIds[i]);
    }
  ...
  public static void decode(Decoder d, Schema o) throws IOException {
    ...
    o.ClassIds = new ClassIdInfo[d.int32()];
    for (int i = 0; i < o.ClassIds.length; i++) {
      o.ClassIds[i] = (ClassIdInfo)d.object();
    }
  ...
  public static void encode(Encoder e, TimingInfo o) throws IOException {
    e.int32(o.FromAtomIds.length);
    for (int i = 0; i < o.FromAtomIds.length; i++) {
      e.uint64(o.FromAtomIds[i]);
    }

    e.int32(o.ToAtomIds.length);
    for (int i = 0; i < o.ToAtomIds.length; i++) {
      e.uint64(o.ToAtomIds[i]);
    }

    e.int32(o.Timers.length);
    for (int i = 0; i < o.Timers.length; i++) {
      e.uint64(o.Timers[i]);
    }
  ...
  public static void decode(Decoder d, TimingInfo o) throws IOException {
    o.FromAtomIds = new long[d.int32()];
    for (int i = 0; i < o.FromAtomIds.length; i++) {
      o.FromAtomIds[i] = d.uint64();
    }

    o.ToAtomIds = new long[d.int32()];
    for (int i = 0; i < o.ToAtomIds.length; i++) {
      o.ToAtomIds[i] = d.uint64();
    }

    o.Timers = new long[d.int32()];
    for (int i = 0; i < o.Timers.length; i++) {
      o.Timers[i] = d.uint64();
    }
