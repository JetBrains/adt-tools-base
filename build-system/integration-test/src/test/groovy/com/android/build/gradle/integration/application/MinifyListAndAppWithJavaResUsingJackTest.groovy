...
import org.junit.BeforeClass;he''
 ...
 */
@CompileStatic
public class MinifyLibAndAppWithJavaResUsingJackTest {
    ...
    @BeforeClass
    static void setUp() {
        project.buildFile << "ext.useJack=true"
    ...
    @Test
    @Ignore // ignore until Jack fixed proguard confusion.
