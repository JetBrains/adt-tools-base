...
/*
COPY of the one in lint; for some reason, at runtime, Gradle/Groovy complains
when attempting to load ResourceUsageAnalyzer:

startup failed:
General error during semantic analysis: java.lang.NoClassDefFoundError: Unable to load class com.android.build.gradle.tasks.ResourceUsageAnalyzer due to missing dependency com/android/tools/lint/checks/ResourceUsageModel

java.lang.RuntimeException: java.lang.NoClassDefFoundError: Unable to load class com.android.build.gradle.tasks.ResourceUsageAnalyzer due to missing dependency com/android/tools/lint/checks/ResourceUsageModel
...
Caused by: java.lang.NoClassDefFoundError: Unable to load class com.android.build.gradle.tasks.ResourceUsageAnalyzer due to missing dependency com/android/tools/lint/checks/ResourceUsageModel
	...
	at org.codehaus.groovy.ast.ClassNode.hasPossibleStaticMethod(ClassNode.java:1303)
	at org.codehaus.groovy.control.StaticImportVisitor.findStaticMethod(StaticImportVisitor.java:541)
	at org.codehaus.groovy.control.StaticImportVisitor.findStaticPropertyAccessorByFullName(StaticImportVisitor.java:527)
	at org.codehaus.groovy.control.StaticImportVisitor.findStaticPropertyAccessor(StaticImportVisitor.java:498)
	at org.codehaus.groovy.control.StaticImportVisitor.findStaticFieldOrPropAccessorImportFromModule(StaticImportVisitor.java:396)
	at org.codehaus.groovy.control.StaticImportVisitor.transformVariableExpression(StaticImportVisitor.java:171)
	at org.codehaus.groovy.control.StaticImportVisitor.transform(StaticImportVisitor.java:72)
	...
	at org.codehaus.groovy.ast.ClassCodeExpressionTransformer.visitIfElse(ClassCodeExpressionTransformer.java:81)
	...
	at org.codehaus.groovy.control.StaticImportVisitor.visitConstructorOrMethod(StaticImportVisitor.java:57)
	...
	at org.codehaus.groovy.control.CompilationUnit$12.call(CompilationUnit.java:659)
