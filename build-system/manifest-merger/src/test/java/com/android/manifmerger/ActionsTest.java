...
public class ActionsTest extends TestCase {
    ...
    public void testActionsPersistenceAndLoading()
        ...
        String expectedMappings = "1<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
                ...
                + "4\n"
                + "5    <permission\n"
                + "5-->ActionsTest#higherPriority:15\n"
                + "6        android:name=\"permissionThree\"\n"
                + "6-->ActionsTest#higherPriority:16\n"
                + "7        android:protectionLevel=\"signature\" >\n"
                + "7-->ActionsTest#higherPriority:17\n"
                + "8    </permission>\n"
                + "9    <permission\n"
                + "9-->ActionsTest#lowerPriorityOne:9\n"
                + "10        android:name=\"permissionTwo\"\n"
                + "10-->ActionsTest#lowerPriorityOne:9\n"
                + "11        android:protectionLevel=\"signature\" >\n"
                + "11-->ActionsTest#lowerPriorityOne:10\n"
                + "12    </permission>\n"
                + "13    <permission\n"
                + "13-->ActionsTest#lowerPriorityTwo:9\n"
                + "14        android:name=\"permissionFour\"\n"
                + "14-->ActionsTest#lowerPriorityTwo:9\n"
                + "15        android:protectionLevel=\"normal\" >\n"
                + "15-->ActionsTest#lowerPriorityTwo:10\n"
                + "16    </permission>\n"
                + "17\n"
                + "18</manifest>\n";
