...
final class PsdTextEngine {
     ...
     */
    static final class ListProperty implements Property<List<Property<?>>> {
     ...
     * associated key.
     */
    static final class MapProperty implements Property<Map<String, Property<?>>> {
...
out:        for (String element : elements) {
    ...
    static final class IntProperty implements Property<Integer> {
        final Integer value;
    ...
    static final class FloatProperty implements Property<Float> {
        final Float value;
    ...
    private Deque<String> mNameStack = new LinkedList<>();
    // Stores maps and arrays
    private Deque<Property> mStack = new LinkedList<>();
    ...
    MapProperty parse(byte[] data) {
        ...
        try {
                    ...
                    if (data[nameEnd] != TOKEN_LINE_END) {
                        ...
                        switch (data[start]) {
                            ...
                            case TOKEN_ARRAY_START:
                                mStack.offerFirst(new ListProperty());
                                // Single-line array
                            ...
                            case TOKEN_STRING_START:
                                ...
                                if (matches(data, TOKEN_BIG_ENDIAN, start + 1)) {
                                    ...
                                    while (data[pos - 1] != TOKEN_STRING_END) {
                                        ...
                                        while (pos < data.length &&
                                                data[pos] != TOKEN_LINE_END) pos++;
                                    }

                                    // Decode the String as a big endian UTF-16 string
                                    value = new String(data, start + 3, pos - start - 4,
                                            "UTF-16BE").replace('\r', '\n');
            ...
            throw new DecoderException("Could not decode text engine data", e);
        }
    ...
    private void addProperty(Property property) {
        Property previous = mStack.peekFirst();
        ...
        switch (previous.getType()) {
            case LIST:
                ...
                break;
            case MAP:
                String name = mNameStack.pollFirst();
