...
final class PsdDecoder extends Decoder {
    ...
    private static Color colorFromCMYK(Descriptor color) {
        float[] rgb = ColorUtilities.linearToSRGB(ColorUtilities.CMYKtoRGB(
    ...
    private static Color colorFromLAB(Descriptor color) {
        float[] rgb = ColorUtilities.linearToSRGB(ColorUtilities.LABtoRGB(
    ...
    private static Color colorFromGray(Descriptor color) {
        float gray = ColorUtilities.linearToSRGB((float) getDouble(color, "Gry ") / 255.0f);
