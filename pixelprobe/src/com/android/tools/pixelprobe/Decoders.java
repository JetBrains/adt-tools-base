...
final class Decoders {
     ...
     */
    static Decoder find(String format) {
        for (Decoder decoder : sDecoders) {
     ...
     * @return A Decoder instance, null if no suitable decoder can be found
     */
    static Decoder find(final InputStream in) {
        for (final Decoder decoder : sDecoders) {
