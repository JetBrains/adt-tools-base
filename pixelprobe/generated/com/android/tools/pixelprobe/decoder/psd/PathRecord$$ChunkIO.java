...
final class PathRecord$$ChunkIO {
    static PathRecord read(RangedInputStream in, LinkedList<Object> stack) throws IOException {
        ...
        if (pathRecord.selector == 0 || pathRecord.selector == 3) {
            ...
            pathRecord.data = PathRecord$BezierKnot$$ChunkIO.read(in, stack);
        }
        in.popRange();
