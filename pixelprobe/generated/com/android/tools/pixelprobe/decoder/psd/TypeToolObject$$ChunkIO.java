...
final class TypeToolObject$$ChunkIO {
    static TypeToolObject read(RangedInputStream in, LinkedList<Object> stack) throws IOException {
        TypeToolObject typeToolObject = new TypeToolObject();
        ...
        typeToolObject.text = Descriptor$$ChunkIO.read(in, stack);
        typeToolObject.warpVersion = in.readShort();
        typeToolObject.warpDescriptorVersion = in.readInt();
        typeToolObject.warp = Descriptor$$ChunkIO.read(in, stack);
