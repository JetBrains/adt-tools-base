 ...
 * A repository describes one or more {@link com.android.sdklib.repository.legacy.remote.internal.packages.Package}s available for download.
 */
      ...
      if (SdkRepoConstants.NODE_LICENSE.equals(name)) {
        ...
        try {
          ...
          while ((archive = findChild(archives, archive, prefix, RepoConstants.NODE_ARCHIVE)) != null) {
            try {
              com.android.sdklib.repository.legacy.remote.internal.archives.ArchFilter af = RemotePackageParserUtils.parseArchFilter(archive);
              if (af == null || !af.isCompatibleWith(com.android.sdklib.repository.legacy.remote.internal.archives.ArchFilter.getCurrent())) {
                continue;
              }
