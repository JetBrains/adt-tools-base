...
public class ArchFilter {
     ...
     * </pre>
     * For the host OS & bit size attribute, if the attributes are non-null they must be equal. For
     * the min-jvm-version, "this" version (the package we want to install) needs to be lower or
