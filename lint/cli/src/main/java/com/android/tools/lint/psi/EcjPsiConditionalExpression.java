...
class EcjPsiConditionalExpression extends EcjPsiExpression implements
    ...
    private PsiExpression mElseExpression;

    private PsiExpression mThenExpression;

    private PsiExpression mCondition;

    EcjPsiConditionalExpression(@NonNull EcjPsiManager manager,
            @NonNull Expression expression) {
        super(manager, expression);
    }

    void setElseExpression(PsiExpression elseExpression) {
        mElseExpression = elseExpression;
    }

    void setThenExpression(PsiExpression thenExpression) {
