...
class EcjPsiAssertStatement extends EcjPsiStatement implements PsiAssertStatement {

    private PsiExpression mCondition;

    private PsiExpression mDescription;

    EcjPsiAssertStatement(@NonNull EcjPsiManager manager,
    ...
    void setDescription(PsiExpression description) {
